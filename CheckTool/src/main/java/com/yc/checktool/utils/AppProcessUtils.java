...
public final class AppProcessUtils {
    ...
    public static String getCurrentProcessNameByActivityThread() {
        ...
        try {
            ...
            Class<?> aClass = Class.forName("android.app.ActivityThread", false, classLoader);
            //ActivityThread.currentProcessName()方法居然是public static的
            final Method declaredMethod = aClass.getDeclaredMethod("currentProcessName", (Class<?>[]) new Class[0]);
