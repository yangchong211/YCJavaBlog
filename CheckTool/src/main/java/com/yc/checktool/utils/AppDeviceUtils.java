...
public final class AppDeviceUtils {
    ...
    public static String getWifiName(Context context){
        ...
        if (wifiManager != null) {
            ...
            ToolLogUtils.i("getWifiName--------",wifiInfo.toString());
            ToolLogUtils.i("getWifiName--------",wifiInfo.getBSSID());
    ...
    public static int getWifiIp(Context context){
        ...
        if (wifiManager != null) {
            wifiInfo = wifiManager.getConnectionInfo();
            ToolLogUtils.i("getWifiIp--------",wifiInfo.toString());
            ToolLogUtils.i("getWifiIp--------",wifiInfo.getBSSID());
